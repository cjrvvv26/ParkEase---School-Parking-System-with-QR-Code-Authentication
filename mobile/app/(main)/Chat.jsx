  ...
  return (
    <SafeAreaView edges={['top']} className='bg-gray-50 flex-1'>
      <View className='flex flex-1 flex-col gap-5'>
        ...
        {/* Content Header */}
        <View className='flex border-y border-y-gray-200 p-5'>
        ...
        <ScrollView
          ...
          contentContainerClassName='flex flex-col gap-5 pb-30'
        >
          {/* Student Chats */}
          <View
          ...
          >
            <View className='flex flex-col'>
              ...
              <View className='bg-violet-500 border border-[#aa85ff] p-3 rounded-lg self-start'>
                <Text className='text-[#310b6a] font-poppins-medium w-52'>
        ...
        <View
          ...
          className='flex flex-row gap-3 items-start border-t border-t-gray-200'
        >
          <TextInput
            ...
            className='bg-violet-500 flex-1 p-4 font-poppins-medium text-white rounded-full border border-[#aa85ff]'
          />
          <Pressable className='bg-violet-500 rounded-full p-4'>
