...
export default function DefaultInput({ label, value, onChange, placeholder, onlyRead, type }) {
  ...
  const inputCls = onlyRead
    ...
    : `mt-2 px-3 py-2 text-sm outline-none rounded-md ring ring-gray-200 hover:ring-violet-500 focus:ring-violet-500 hover:ring-2 focus:ring-2 ${dark ? 'bg-[#3a3a3a] ring-[#4a4a4a] text-gray-200 placeholder-gray-500' : 'bg-white text-gray-700 placeholder-gray-400'}`;
