...
export default function Navbar({ show, toggleShow }) {
  ...
  return (
    <div
      ...
      className={`${show ? 'w-[250px]' : 'w-[80px]'} relative z-10 duration-100 rounded-xl h-[calc(100vh-16px)] ${
    ...
    >
      ...
      <div className='flex items-center justify-center h-[80px]'>
        {show ? (
          <div className='flex gap-2 items-center'>
            ...
            <h1 className='text-blue-500 text-sm font-bold leading-tight'>
              School Parking
              <br />
              System
            </h1>
      ...
      <div className={`flex flex-col ${show ? '' : 'items-center'}`}>
        <p
          className={`${show ? 'ml-4' : ''} text-xs ${dark ? 'text-gray-500' : 'text-gray-400'}`}
        >
          Main
        </p>
        ...
        <p
          className={`${show ? 'ml-4' : ''} text-xs mt-2 ${dark ? 'text-gray-500' : 'text-gray-400'}`}
        >
          Management
        </p>
