    ...
    <div className="flex flex-col gap-3 text-gray-700 text-xs p-2 border-b border-gray-200">
      ...
      <section className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <button className="rounded-md py-2 px-3 border border-gray-200 flex gap-2 items-center hover:text-gray-500">
            <Eye strokeWidth={1.5} className="size-4" />
            <span>Preview</span>
          </button>
          <button className="rounded-md py-2 px-3 bg-violet-500 text-white">
            Save
          </button>
        </div>
      </section>
