      ...
      <section className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          {isUpdateMode && (
            <button
              onClick={onDelete}
              className="rounded-md py-2 px-3 border border-rose-300 text-rose-500 hover:bg-rose-50 flex items-center gap-2 transition"
            >
          ...
          <button
            onClick={onSave}
            disabled={isSaving}
            className="rounded-md py-2 px-3 bg-violet-500 text-white disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {isSaving ? (
              <>
                <svg
