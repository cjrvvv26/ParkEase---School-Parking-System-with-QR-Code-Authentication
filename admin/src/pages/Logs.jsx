    ...
    <>
      ...
      <div className="flex justify-between items-center pt-5 px-5">
        ...
        <div className="flex gap-5 items-center text-gray-400">
          <p className="text-sm">1-20 of 1,200</p>
          {/* Pagination */}
      ...
      <div className="flex flex-col">
        ...
        {/* Table Row */}
        <div className="py-2 px-5 bg-gray-100 w-full grid grid-cols-[230px_2fr_auto] gap-3">
          {/* Who did action */}
          <div className="flex gap-3 items-center">
            <img
              src="https://images.unsplash.com/photo-1497752531616-c3afd9760a11?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fGFuaW1hbHxlbnwwfHwwfHx8MA%3D%3D&fm=jpg&q=60&w=3000"
              alt=""
          ...
          <div className="flex items-center text-left overflow-hidden">
            <p className="truncate text-gray-700">
              ...
              <span className="font-medium text-gray-700">
                Clarence V. Started Parking:
              </span>{" "}
              User “Clarence V.” started a parking session in Slot A12.
            </p>
          </div>
          {/* Timestamps */}
