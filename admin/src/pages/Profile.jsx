...
export default function Profile() {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'username' && value.length > 35) {
      return setError('Characters is too long.');
    }
  ...
  const handleUpdate = async (name, value) => {
    const updatedInfo = await fetchData('/super-admin/me', {
      method: 'PATCH',
      data: {
        [name]: value,
      },
    ...
    <>
      ...
      <div className='mx-5 mt-5'>
        ...
        <div className='flex gap-8'>
          ...
          <div className='flex items-center flex-col gap-5'>
            <div className='relative'>
              {information?.profileDetails?.url ? (
                <img
                  src={information?.profileDetails?.url}
                  alt='Profile'
                  className='w-50 h-50 rounded-full border-4 border-violet-500 object-cover'
                />
              ) : (
                <UserCircle className='size-45 text-gray-600' strokeWidth={1} />
              )}
          ...
          bg-violet-500 text-white font-medium shadow
          hover:bg-violet-400 active:scale-95 transition relative'
            >
              <input
                type='file'
                name='profileDetails'
              ...
              <div className='relative flex-1 max-w-md'>
                <input
                  ...
                  className={`w-full px-3 py-2 pr-8 rounded-md
                      border text-gray-800 outline-none
                      ${
                ...
                />
                {(editingField !== 'username' || !editingField) && (
                  <span
            ...
            <div className='flex items-center gap-3 group'>
              ...
              <div className='relative flex-1 max-w-md'>
                <input
                  ...
                  cursor-pointer group-hover:border-violet-500 outline-none'
                />

                {(editingField !== 'name' || !editingField) && (
                  <span
            ...
            <div className='flex items-center gap-3'>
              ...
              <div className='relative flex-1 max-w-md'>
                <input
                  ...
                  bg-gray-50 border border-gray-200 text-gray-800 outline-none'
                />
              </div>
            </div>
